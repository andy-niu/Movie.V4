...
namespace M.ServiceAPI.Controllers
{
    ...
    public class SystemConfigMenuController : ControllerBase
    {
        private ISystemConfigMenuService _service;
        public SystemConfigMenuController(ISystemConfigMenuService service)
        {
            _service = service;
        }
        ...
        public async Task<IActionResult> GetList(SystemConfigMenu model, int page = 1, int pageSize = 10)
        {
            try
            {
        ...
        [HttpPost("save")]
        public async Task<IActionResult> Save([FromBody]SystemConfigMenu model)
        {
            try
            {
        ...
        [HttpPut("edit")]
        public async Task<IActionResult> Edit([FromBody]SystemConfigMenu model)
        {
            try
            {
        ...
        [HttpDelete("destory")]
        public async Task<IActionResult> Destory([FromBody]SystemConfigMenu model)
        {
            try
            {
